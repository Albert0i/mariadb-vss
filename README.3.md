...
#### V. Summary 
- Part 1: HNSW key concepts, documentation on MariaDB and Redis; 
- Part 2: Implementation of VSS using MariaDB via Prisma ORM and node-llama-cpp; 
- Part 3: Implementation of VSS using Redis via RedisJSON, RediSearch and node-llama-cpp; 
